...
import test.resources.SimpleParams;
...
public class TestParams {
	...
	SimpleParams writeParams = new SimpleParams();
	...
	SimpleParams readParams = ParamsUtil.readFromXml(PARAMS_PATH,
		SimpleParams.class);
	...
	try {
	    ParamsUtil.readFromXml(invalidParamsPath, SimpleParams.class,
		    schemaPath);
