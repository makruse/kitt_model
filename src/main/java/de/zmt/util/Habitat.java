...
public enum Habitat {
    ...
    private static final Amount<Frequency> CORALREEF_MORTALITY_RISK = Amount
	    .valueOf(CORALREEF_MORTALITY_RISK_PER_DAY_VALUE, UnitConstants.PER_DAY).to(UnitConstants.PER_STEP);
    ...
    private static final Amount<Frequency> SEAGRASS_MORTALITY_RISK = Amount
	    .valueOf(SEAGRASS_MORTALITY_RISK_PER_DAY_VALUE, UnitConstants.PER_DAY).to(UnitConstants.PER_STEP);
    ...
    private static final Amount<Frequency> MANGROVE_MORTALITY_RISK = Amount
	    .valueOf(MANGROVE_MORTALITY_RISK_PER_DAY_VALUE, UnitConstants.PER_DAY).to(UnitConstants.PER_STEP);
    ...
    private static final Amount<Frequency> ROCK_MORTALITY_RISK = Amount
	    .valueOf(ROCK_MORTALITY_RISK_PER_DAY_VALUE, UnitConstants.PER_DAY).to(UnitConstants.PER_STEP);
    ...
    private static final Amount<Frequency> SANDYBOTTOM_MORTALITY_RISK = Amount
	    .valueOf(SANDYBOTTOM_MORTALITY_RISK_PER_DAY_VALUE, UnitConstants.PER_DAY).to(UnitConstants.PER_STEP);
    ...
    public static final Amount<Frequency> MAX_MORTALITY_RISK = SANDYBOTTOM_MORTALITY_RISK;
    ...
    /**
     * Estimated mortality risk as a summarizing factor of habitat complexity,
