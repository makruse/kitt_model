...
final class HabitatConstants {
    ...
    static final double CORALREEF_FOOD_MIN_VALUE = 15; //5
    static final double CORALREEF_FOOD_MAX_VALUE = 45; //15
    ...
    static final double SEAGRASS_FOOD_MAX_VALUE = 20;
    ...
    static final double MANGROVE_FOOD_MIN_VALUE = 5;
    static final double MANGROVE_FOOD_MAX_VALUE = 10;
    ...
    static final double ROCK_FOOD_MIN_VALUE = 5;
    static final double ROCK_FOOD_MAX_VALUE = 10;
    ...
    static final double SANDYBOTTOM_FOOD_MIN_VALUE = 1; //0.1
    static final double SANDYBOTTOM_FOOD_MAX_VALUE = 5;   //3
