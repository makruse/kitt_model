...
public class ModelParams {
	 ...
	 * speciesList.add( new SpeciesDefinition()); writeToXml(currentPath);
	 * // just for first run
	 */
	try {
	...
	try {
	    ...
	    ModelParams readConfig = (ModelParams) unmarshaller
		    .unmarshal(new FileReader(currentPath));
	...
	// if the directed flag has been modified after reading, recover the
	// original file value
    ...
    /**
     * sets the path for the next configuration file to run when start is called
     * again
     */
