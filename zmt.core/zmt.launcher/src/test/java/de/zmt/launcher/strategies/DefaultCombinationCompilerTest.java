...
public class DefaultCombinationCompilerTest {
    ...
    private static final Logger logger = Logger
	    .getLogger(DefaultCombinationCompilerTest.class.getName());
    ...
    private static final AutoDefinition DEFINITION_1 = new AutoDefinition(
	    new AutoDefinition.FieldLocator(TestDefinition.class,
		    TestDefinition.FIELD_NAME_DOUBLE), Arrays.<Object> asList(
		    1.5, 2.5, 0.5));
    private static final AutoDefinition DEFINITION_2 = new AutoDefinition(
	    new AutoDefinition.FieldLocator(TestDefinition.class,
		    TestDefinition.FIELD_NAME_INT), Arrays.<Object> asList(4,
		    8, 2));
	...
	assertTrue("Combinations contain: " + combinationsFromEmpty,
		combinationsFromEmpty.isEmpty());
    }
     ...
     */
    private static Collection<Combination> collectCombinations(
	    Iterable<AutoDefinition> autoDefinitions) {
	Collection<Combination> combinations = new ArrayList<>();
	for (Combination combination : BATCH_COMPILER
		.compileCombinations(autoDefinitions)) {
