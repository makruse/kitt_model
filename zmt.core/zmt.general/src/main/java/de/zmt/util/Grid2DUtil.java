...
public final class Grid2DUtil {
     ...
     * 
     * @see <a
     *      href="http://tech-algorithm.com/articles/drawing-line-using-bresenham-algorithm"/>Drawing
     *      Line Using Bresenham Algorithm</a>
     * @param start
     *            start point
     * @param end
     *            end point
     ...
     * 
     * @see sim.field.grid.Grid2D#getRadialLocations(int, int, double, int,
     *      boolean, int, boolean, IntBag, IntBag)
     * @param width
     *            grid width
     * @param height
     *            grid height
     ...
     * 
     * @see <a
     *      href="http://www.gamasutra.com/view/feature/131790/simple_intersection_tests_for_games.php?page=4">Gamasutra:
     *      A Box-Sphere Intersection Test</a>
     * @param circleCenter
